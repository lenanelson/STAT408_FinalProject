...
print(intercept)
```
Well those labels don't make a lot of sense. Let's try again using `cat` which allows you concatenate and print. To use the function, we are first putting the text we want into the "quotes followed by the dataframe we are using, and then we use "\n" to create a new line so everything isn't squished!
